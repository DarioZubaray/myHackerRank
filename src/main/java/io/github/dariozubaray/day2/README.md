...
- The first line of each query contains an integer, `n`.
 - Each of the next `2n` lines contains `2n` space-separated integers `matrix[i][j]` in row `i` of the
matrix
...
###### Explanation
Start out with the following `2 x 2` matrix:
...
2. Reverse column `2`(`[83, 56, 101, 114] -> [114, 104, 56, 83]`), resulting in the matrix:


```
            [112   42  114  119]
matrix =    [ 56  125  101   49]
            [ 15   78   56   43]
            [ 62   98   83  108]
```
